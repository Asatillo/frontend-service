            ...
            <v-card v-if="deviceToSell">
                ...
                <v-card-text>
                    <v-autocomplete v-model="selectedCustomer" label="To Customer" :items="customers" required chips
                        item-title="name" item-value="id" @update:search="updateCustomers" no-data-text="No customer with such name">
                    </v-autocomplete>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="primary" text @click="closeSellDialog">Cancel</v-btn>
                    <v-btn color="primary" text @click="sellDevice(deviceToSell.id, selectedCustomer)" :disabled="!selectedCustomer">Sell</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-container>

<template>
    <v-card class="rounded-xl">
        ...
        <v-card-title class="pr-0 d-flex justify-space-between ">
            <p class="ma-2 mp-2 text-truncate">{{ deviceTemplate.brand + ' ' +
                deviceTemplate.model }}</p>
            ...
            <v-menu class="ma-2 mp-2">
                ...
                <v-list>
                    ...
                    <v-list-item class="pa-0">
                        <v-btn variant="text" @click="$emit('sell', deviceTemplate)">
                            Edit
                        </v-btn>
                    </v-list-item>
                </v-list>
        ...
        <v-container v-if="deviceTemplate.deviceType == 'MOBILE'" class="pt-0">
            <v-card-subtitle>
